...
urlpatterns = [
    ...
    path('edificacion/<int:pk>/comentario/', views.EdificacionDetailAV.as_view(), name='list-all-comentarios'),       # /inmueble/comentario/list/
    path('edificacion/comentario/<int:pk>/', views.ComentarioDetailGAV.as_view(), name='get-comentario-by-id'), # /inmueble/comentario/list/
]